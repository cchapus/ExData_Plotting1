...
##          Repository and plot a histogram of the Global  ##
##          Active Power                                   ##
...
## Plot the Histogram of Global Active Power and save it as PNG file
png(file="plot1.png",width=480,height=480)
with(data2,hist(Global_active_power,col="red",main="Global Active Power",xlab="Glocal Active Power (kilowatts)"))
dev.off()
